...
import { deleteSocial } from "@/lib/actions/social.actions";
...
const DeleteSocialButton = ({ socialId, requiredPhrase, onDelete }: Props) => {
  ...
  const handleDelete = () => {
    if (confirmationPhrase !== requiredPhrase) {
      toast.error(
        `Please type &quot;${requiredPhrase}&quot; to confirm deletion.`
      );
      return;
    }
    ...
    deleteSocial(socialId)
      ...
      .catch((error) => {
        ...
        toast.error("An error occurred while deleting the social.");
        setLoading(false);
      });
  };
      ...
      <DialogContent>
        <DialogHeader>
          ...
          <DialogDescription>
            ...
            Instagram Reel from the server and off of your site.
          </DialogDescription>
          <div className="mt-4">
            <label
...
export default DeleteSocialButton;
